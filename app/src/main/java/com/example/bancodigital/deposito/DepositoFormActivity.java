...
public class DepositoFormActivity extends AppCompatActivity {
    ...
    public void validaDeposito(View view) {
        ...
        //getRawValue = pegar valor inteiro sem a mascara
    ...
    private void salvarDeposito(Extrato extrato) {
        ...
        depositoRef.setValue(deposito).addOnCompleteListener(task -> {
           if (task.isSuccessful()){
               ...
               //aqui entramos na activity do deposito
    ...
    // esse metodo vai ser exibido sempre que acontecer um erro do usuario digitar um valor 0
    // que assim ira mostar uma nova janela pequena identificando o erro cometido.
    // foi atribuido o "String msg" para assim poder usar em varios metodos
